...
public final class Display {
    ...
    public Display(final boolean negative) {
            ...
            public void run() {
                ...
                while (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    try {
                        ...
                        final String ascii = new Display().convert(image);
                        ...
                        final JDialog dialog = new JOptionPane(new JScrollPane(textArea), JOptionPane.PLAIN_MESSAGE).createDialog(Display.class.getName());
